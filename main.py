...
MODEL_PATH_m = 'C:/Users/SHADOW/Project/health_detector/model/model_cnn_malaria.h5'
MODEL_PATH_c = 'C:/Users/SHADOW/Project/health_detector/model/model_cnn_covid19.h5'
MODEL_PATH_bt = 'C:/Users/SHADOW/Project/health_detector/model/model_cnn_brain_tumor.h5'

# Load your trained model
model_m = load_model(MODEL_PATH_m)
model_c = load_model(MODEL_PATH_c)
model_bt = load_model(MODEL_PATH_bt)


def model_predict(img_path, model_m):
...
def model_predict2(img_path, model_bt):
    img = image.load_img(img_path, target_size=(224, 224))
...
@app.route("/Malaria/Malaria_res", methods=['GET', 'POST'])
def Malaria_res():
    global res1
    if request.method == 'POST':
        ...
        # Make prediction
        res1 = model_predict(file_path, model_m)

    return render_template("result.html", prediction=res1, this='Malaria')
...
@app.route("/Brain_Tumor/Brain_Tumor_res", methods=['GET', 'POST'])
def Brain_Tumor_res():
    global res3
    if request.method == 'POST':
        # Get the file from post request
        ...
        # Make prediction
        res3 = model_predict2(file_path, model_bt)

    return render_template("result1.html", prediction=res3)
